...
本文实现说明对应仓库的 `src/model/` 与 `src/algorithm/`，验证事实引用 `docs/A1图结构验证记录.md`、`docs/A2基础拓扑排序验证记录.md`、`docs/A4环检测及路径定位验证记录.md`、`docs/A3多序列枚举初版验证记录.md` 及对应输出。本轮是文档修订，没有重新运行算法测试；A1/A2/A4/A3 已保存的作者自测分别为 16/19/19/25 组通过，不能替代 D/E 的正式测试章节和跨模块联调。
